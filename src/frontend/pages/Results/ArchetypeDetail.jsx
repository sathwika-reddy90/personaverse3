          ...
          <div className="grid grid-cols-2 gap-3">
            {others.map((a, i) => (
              <motion.button
                ...
                className="relative overflow-hidden rounded-2xl p-4 text-left text-white shadow-card border border-white/15 hover-lift"
              >
                <div className="absolute inset-0 gradient-archetype-grid" />
